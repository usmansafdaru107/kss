...
$(document).ready(function() {
	...
	$("#countscript").countdown({
		date: "13 May 2017 12:00:00", /** Enter new date here **/
		format: "on"
	},
	function() {
		// callback function
	...
	$('#contact').submit( function(e){
				...
				var fnamex=$('.fname').val();
				var lnamex=$('.lname').val();
				var companyx=$('.company').val();
				var listx=$('.list').val();
				var attachmentx=$('.attachment').val();
				...
				alert(JSON.stringify(form4enroll));
				$.ajax(sendSettings).success(function(response){
