		...
		Available Units / 
		<button class="forAdminOnly pull-right addUnitBtn btn btn-xs btn-primary" data-toggle="modal" data-target="#addNewUnit"><span class="fa fa-plus"> </span> Add a Unit/ Theme</button>
		</h4>
		<br>
		<div class="row filter-units-main"> 
				<div class="col-md-4"> 
...
<div class="modal fade" id="deleteUnit" role="dialog">
	...
	<div class="modal fade" id="editUnit" role="dialog">
      ...
      <div class="modal-footer">
		...
		<script src="js/unitsCrud.js" defer></script>
