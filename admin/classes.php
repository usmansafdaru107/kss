...
<button class="btn btn-primary forAdminOnly" data-toggle="modal" data-target="#addNewClass"><span class="fa fa-plus"> </span> Add a class</button>';
		...
		<thead>
			<tr>
				<th># Class No</th>
				<th><span class="fa fa-university"> </span>Short Name</th>
					<th><span class="fa fa-graduation-cap"> </span>Full Class Name</th>
					<th><span class="fa fa-pencil"> </span> Enrolled</th>
...
<script src="js/classCrud.js" defer></script>		
